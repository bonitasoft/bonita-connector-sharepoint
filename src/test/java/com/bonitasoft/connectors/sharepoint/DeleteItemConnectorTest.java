...
class DeleteItemConnectorTest {

    @Mock
    private SharePointClient mockClient;

    private DeleteItemConnector connector;
    private Map<String, Object> inputs;

    @BeforeEach
    void setUp() {
        connector = new DeleteItemConnector();
        inputs = new HashMap<>();
    ...
    void shouldExecuteSuccessfully() throws Exception {
        ...
        assertThat(getOutput(connector, "deletedItemId")).isEqualTo("item-to-delete");
        assertThat(getOutput(connector, "permanent")).isEqualTo(false);
    }
    ...
    void shouldRetryOnRateLimit() throws Exception {
        ...
        when(mockClient.deleteItem(any()))
