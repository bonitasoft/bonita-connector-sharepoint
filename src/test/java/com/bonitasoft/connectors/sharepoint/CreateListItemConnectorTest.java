...
class CreateListItemConnectorTest {

    @Mock
    private SharePointClient mockClient;

    private CreateListItemConnector connector;
    private Map<String, Object> inputs;

    @BeforeEach
    void setUp() {
        connector = new CreateListItemConnector();
        inputs = new HashMap<>();
    ...
    void shouldExecuteSuccessfully() throws Exception {
        ...
        assertThat(getOutput(connector, "listItemWebUrl")).isEqualTo("https://sp.com/list/item");
    ...
    void shouldRetryOnRateLimit() throws Exception {
        ...
        when(mockClient.createListItem(any()))
