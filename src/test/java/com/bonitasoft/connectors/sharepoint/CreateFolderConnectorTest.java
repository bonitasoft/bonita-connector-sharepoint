...
class CreateFolderConnectorTest {
    ...
    void shouldExecuteSuccessfully() throws Exception {
        ...
        assertThat(getOutput(connector, "folderId")).isEqualTo("folder-123");
        assertThat(getOutput(connector, "folderWebUrl")).isEqualTo("https://sp.com/folder");
    }
    ...
    void shouldRetryOnRateLimit() throws Exception {
        ...
        when(mockClient.createFolder(any()))
