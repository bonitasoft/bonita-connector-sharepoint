...
class ListChildrenConnectorTest {

    @Mock
    private SharePointClient mockClient;

    private ListChildrenConnector connector;
    private Map<String, Object> inputs;

    @BeforeEach
    void setUp() {
        connector = new ListChildrenConnector();
        inputs = new HashMap<>();
    ...
    void shouldExecuteSuccessfully() throws Exception {
        ...
        assertThat(getOutput(connector, "totalCount")).isEqualTo(1);
    }
    ...
    void shouldRetryOnRateLimit() throws Exception {
        ...
        when(mockClient.listChildren(any()))
