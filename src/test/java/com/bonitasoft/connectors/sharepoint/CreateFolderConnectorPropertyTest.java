...
class CreateFolderConnectorPropertyTest {
    ...
    @Property
    void folderNameRejectsBlank(@ForAll("blankStrings") String value) {
        var connector = new CreateFolderConnector();
        var inputs = validInputs();
        inputs.put("folderName", value);
        connector.setInputParameters(inputs);
        assertThatThrownBy(() -> connector.validateInputParameters())
                .isInstanceOf(ConnectorValidationException.class);
    }
    ...
    @Property
    void folderNameAcceptsValidNonBlank(@ForAll("nonBlankStrings") String value) {
        var connector = new CreateFolderConnector();
        var inputs = validInputs();
        inputs.put("folderName", value);
        connector.setInputParameters(inputs);
    ...
    private Map<String, Object> validInputs() {
        ...
        inputs.put("folderName", "TestFolder");
        return inputs;
    }
}
