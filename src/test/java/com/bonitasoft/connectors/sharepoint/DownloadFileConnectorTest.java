...
class DownloadFileConnectorTest {
    ...
    void shouldExecuteSuccessfully() throws Exception {
        ...
        assertThat(getOutput(connector, "fileContentBase64")).isEqualTo("dGVzdA==");
        assertThat(getOutput(connector, "fileName")).isEqualTo("report.pdf");
        assertThat(getOutput(connector, "mimeType")).isEqualTo("application/pdf");
        assertThat(getOutput(connector, "fileSizeBytes")).isEqualTo(1024L);
    }
    ...
    void shouldRetryOnRateLimit() throws Exception {
        ...
        when(mockClient.downloadFile(any()))
