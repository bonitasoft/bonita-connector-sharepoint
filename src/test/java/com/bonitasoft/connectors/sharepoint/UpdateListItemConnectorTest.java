...
class UpdateListItemConnectorTest {

    @Mock
    private SharePointClient mockClient;

    private UpdateListItemConnector connector;
    private Map<String, Object> inputs;

    @BeforeEach
    void setUp() {
        connector = new UpdateListItemConnector();
        inputs = new HashMap<>();
    ...
    void shouldExecuteSuccessfully() throws Exception {
        ...
        assertThat(getOutput(connector, "lastModifiedDateTime")).isEqualTo("2024-01-02T12:00:00Z");
    }
    ...
    void shouldRetryOnRateLimit() throws Exception {
        ...
        when(mockClient.updateListItem(any()))
